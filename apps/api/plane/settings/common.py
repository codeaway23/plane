...
STRIPE_SUCCESS_URL = os.environ.get("STRIPE_SUCCESS_URL", "http://localhost:3000/{workspace_slug}/settings/billing?success=true")
STRIPE_CANCEL_URL = os.environ.get("STRIPE_CANCEL_URL", "http://localhost:3000/{workspace_slug}/settings/billing?canceled=true")
...
STRIPE_AI_GENERAL_RUN_PRICE_ID = os.environ.get("STRIPE_AI_GENERAL_RUN_PRICE_ID", "price_1S4D5TEPoCJr6b2KZa4YIXXv")
STRIPE_AI_CODE_RUN_PRICE_ID = os.environ.get("STRIPE_AI_CODE_RUN_PRICE_ID", "price_1S4Df6EPoCJr6b2KDrZ9aJ18")
STRIPE_CORE_AI_PACK_PRICE_ID=os.environ.get("STRIPE_CORE_AI_PACK_PRICE_ID", "price_1S4DghEPoCJr6b2KcUgFgAJC")
STRIPE_SCALE_AI_PACK_PRICE_ID=os.environ.get("STRIPE_SCALE_AI_PACK_PRICE_ID", "price_1S4DhGEPoCJr6b2KlaakWqPn")